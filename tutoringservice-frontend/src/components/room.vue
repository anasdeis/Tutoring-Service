...
<template>
    <div id="room" class="card" v-bind:style="{ backgroundColor : bgColor }">
        <span id = "title" v-bind:style="{color : textColor}"><center>View Rooms</center></span>
        <div>
            <span id = "title1"></span>
        </div>
        <b-container> 
            <b-row>
                <b-col id="smallroom"> 
                    ...
                    <button type="button" @click="viewRoomStatus()" class="btn btn-primary brn-lg room button" v-b-tooltip.hover title="View status">View Status</button> 
                </b-col>
                <b-col id="bigroom"> 
